...
const Home = () => {
  ...
  return (
    <div
      style={{ backgroundColor: "#141414", color: "white", minHeight: "100vh" }}
    >
      {/* Hero Section */}
      <div
      ...
      <Container>
        ...
        <section className="my-5">
          ...
          {!errorPopular && popularMovies.length > 0 && (
          ...
          {!hasMorePopular && popularMovies.length > 0 && (
            <p className="text-center mt-3">No more popular movies to load.</p>
          )}
        </section>
      </Container>
    </div>
